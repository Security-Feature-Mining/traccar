    ...
    protected Object decode(
        ...
        if (buf.getUnsignedByte(buf.readerIndex()) == 0xF8) {
            ...
            if (channel != null) {
                ...
                response.writeShort(Checksum.crc16(Checksum.CRC16_XMODEM, response.nioBuffer(1, 4))); // &line[Checksum]
                response.writeByte(0xF8);
            ...
            if (channel != null) {
                channel.writeAndFlush(new NetworkMessage(Unpooled.copiedBuffer(String.format("*TS01,ACK:%04X#",
                        Checksum.crc16(Checksum.CRC16_XMODEM, buf.nioBuffer(1, buf.writerIndex() - 2))), // &line[Checksum]
